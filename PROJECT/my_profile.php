          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="pharmacy_name" type="text" class="form-control" value="<?php $pharmacy_name=''; echo $pharmacy_name; ?>" placeholder="pharmacy name" onkeyup="validateName(this.value, 'pharmacy_name_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <textarea id="address" class="form-control" placeholder="address" onkeyup="validateAddress(this.value, 'address_error');" style="max-height: 100px;" disabled><?php $address=''; echo $address; ?></textarea>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="email" type="email" class="form-control" value="<?php $email=''; echo $email; ?>" placeholder="email" onkeyup="notNull(this.value, 'email_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="contact_number" type="number" class="form-control" value="<?php $contact_number=''; echo $contact_number; ?>" placeholder="contact number" onkeyup="validateContactNumber(this.value, 'contact_number_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="username" type="text" class="form-control" value="<?php $username=''; echo $username; ?>" placeholder="username" onkeyup="notNull(this.value, 'username_error');" disabled>
